...
def find_physio_dir(subject_id, physio_session='ses-2'):
    ...
    for variant in ['Scanner_physio', 'Scanner_Physio', 'scanner_physio', 'scanner_Physio']:
    ...
    raise FileNotFoundError(
        ...
        f"   Checked: Scanner_physio, Scanner_Physio, scanner_physio, scanner_Physio"
    )
# ============================================================================
# MAIN PIPELINE
# ============================================================================
